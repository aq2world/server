...
RUN apt-get update && \
    DEBIAN_FRONTEND=noninteractive apt-get -y install wget nano unzip
...
RUN mkdir -p /aq2server/action/map_overrides
...
ENV USE_VOICE 1
ENV USE_GHOSTS 1
ENV MASTER  "master.quadaver.org master.q2servers.com master.aq2world.com netdome.biz master.quakeservers.net master.frag-net.com:27950 dpmaster.deathmask.net:27950 dpmaster.tchr.no:27950"
ENV _ADMIN AQ2WORLD
ENV AWS_ACCESS_KEY NONE
ENV STAT_APIKEY ""
ENV Q2A_CONFIG q2admin_public.lua
...
ENV PRINTRULES 0
ENV TIMEDMSGS 0
ENV G_HIGHSCORES_DIR "highscores"
ENV G_HIGHSCORES_COUNTBOTS 0
...
ENV BOT_RAGEQUIT 0
ENV BOT_COUNTASHUMAN 1
ENV BOT_NAVAUTOGEN 1
ENV BOT_DEBUG 0
ENV BOT_REPORTASCLIENT 0
...
ENV SV_CURL_STAT_ENABLE 0
ENV SV_DISCORD_ANNOUNCE_ENABLE "disabled"
ENV SV_AWS_ACCESS_KEY "disabled"
ENV SV_AWS_SECRET_KEY "disabled"
ENV SV_CURL_DISCORD_INFO_URL "disabled"
ENV SV_CURL_DISCORD_PICKUP_URL "disabled"
